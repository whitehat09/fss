...
import "./THANGHNTRANSFER.css";
class THANGHNTRANSFER extends Component {
  constructor(props) {
    super(props);
    this.state = {
      CUSTID: "",
  ...
  getOptionsThangHNcustodycd() {
    //lay ds careby
    return RestfulUtils.post("/THANGHNTRANSFER/getthanghn_balance", {
      language: this.props.lang,
      objname: "THANGHNTRANSFER",
    }).then((res) => {
      this.setState({
  ...
  async submitGroup() {
    var mssgerr = "";
    if (mssgerr == "") {
      var api = "/THANGHNTRANSFER/thangHNChangeBalance";
...
module.exports = decorators(THANGHNTRANSFER);
