...
import THNATable from "./components/THNATable";
import THNAModalDetail_info from "./components/THNAModalDetail_info";
class THANGHNACCOUNT extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
const decorators = flow([connect(stateToProps), translate("THANGHNACCOUNT")]);
module.exports = decorators(THANGHNACCOUNT);
